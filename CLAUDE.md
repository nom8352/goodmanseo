...
- keep the `1080x1920` share image phone-first for Shorts, Instagram, and X: use mid-sized headlines at roughly twice the original scale, the complete compact 1–2 sentence summary, and a source label
