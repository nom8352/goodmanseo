...
| `/pricing` | GoodmanSEO service pricing / compare website, AI diagnosis, SEO, Google Business Profile services | free check, AI diagnosis, website package, SEO package, Google Business Profile setup, basic social link support | service-specific inquiry buttons to `/contact?type=...` | Navbar, homepage CTAs, blog service CTAs, footer | `/contact?type=free-check`, `/contact?type=starter-homepage`, `/contact?type=seo-start-package` |
...
| `/contact` | request website, AI diagnosis, or inquiry / submit business check form | free check application, AI diagnosis inquiry, homepage quote, SEO inquiry, AI mentoring inquiry | form submission | Navbar CTA, homepage, pricing, starter package, blog CTAs, AI pages, footer | none after form; keep as conversion endpoint |
