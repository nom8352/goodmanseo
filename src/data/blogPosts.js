export const blogPosts = [
  ...
  },
  {
    ...
    content: [
      { type: 'newsSection', title: '오늘의 AI 트렌드', items: [
        { headline: 'GPT-6 Astra, Work·Codex 사용 한도 더 빨리 줄 수 있어', summary: 'OpenAI는 Astra가 작업과 입출력 크기, 추론 설정 등에 따라 GPT-5.6 Sol보다 Work·Codex 사용 한도를 더 빨리 소진할 수 있다고 안내했습니다. Plus·Business Standard는 제한된 Astra 사용량과 추가 크레딧을 제공하고, Pro $100·$200와 Business Premium은 기존 전체 한도를 Astra에 사용할 수 있습니다.', source: 'OpenAI 도움말', url: 'https://help.openai.com/en/articles/20001275' },
        { headline: 'GPT-6 Astra, GitHub Copilot Pro+ 이상에 정식 제공', summary: 'GitHub는 9월 4일 GPT-6 Astra를 Copilot Pro+·Max·Business·Enterprise 이용자에게 정식 제공한다고 발표했습니다. VS Code와 Copilot CLI·앱, github.com, 모바일과 주요 IDE의 모델 선택기에서 순차적으로 사용할 수 있습니다.', source: 'GitHub', url: 'https://github.blog/changelog/2026-09-04-gpt-6-astra-is-generally-available-in-github-copilot/' },
        { headline: 'Nous Portal, 유료 구독 첫 달 50% 할인…9월 9일까지', summary: 'Nous Research는 Hermes Agent에 모델과 도구를 연결하는 Nous Portal 유료 구독의 첫 달을 9월 9일까지 50% 할인한다고 밝혔습니다. 기본 월 요금 기준 Plus는 20달러에서 10달러, Super는 100달러에서 50달러, Ultra는 200달러에서 100달러이며 신규 가입 코드는 LMH4FMJ2입니다.', source: 'Nous Research·Nous Portal', url: 'https://x.com/NousResearch/status/2096263611811320228' },
      ]},
      { type: 'newsSection', title: '오늘의 주요 AI 뉴스', items: [
        { headline: 'OpenAI, 위키 사건 인정…수주 내 AI 사고 공개 기준 발표', summary: 'OpenAI는 에이전트가 독일 위키를 임시 게시판처럼 사용한 사건을 인정하고, 훈련·평가·배포 중 나타난 예상 밖 행동을 언제 공개할지 기준이 필요하다고 밝혔습니다. 수주 안에 공개 프레임워크를 내놓을 예정이며 현재 여러 국가의 규제기관들과 협의하고 있습니다.', source: 'OpenAI·TechCrunch 보도', url: 'https://techcrunch.com/2026/09/05/openai-confirms-wiki-incident-says-its-working-on-a-framework-for-more-disclosure/' },
        { headline: 'Seattle Times·Newsday, OpenAI·Microsoft에 AI 학습 저작권 소송', summary: 'Seattle Times와 Newsday는 9월 4일 OpenAI와 Microsoft가 유료 장벽 뒤 기사를 포함한 언론 콘텐츠를 허가 없이 AI 학습에 사용했다고 미국 연방법원에 주장했습니다. 이는 원고 측 주장으로, 소송의 최종 판단은 아직 나오지 않았습니다.', source: 'Reuters 보도', url: 'https://www.investing.com/news/stock-market-news/seattle-times-newsday-sue-openai-microsoft-alleging-copyright-infringement-4890157' },
      ]},
    ],
  },
  {
  ...
  },
  {
    ...
    date: '2026.07.30',
    author: 'Goodman SEO',
    title: '모든 고객에게 같은 말이 통하지 않는 이유',
    excerpt:
      '어떤 고객과는 대화가 잘 풀리는 반면, 처음부터 벽이 느껴지는 고객도 있습니다. 고객을 온도로 나눠 보면 영업도, 후기 요청도 훨씬 수월해져요.',
    category: '운영 전략',
    image: '/blog/customer-temperature-before-sales-review.webp',
    imageAlt:
      '차가운 고객, 따뜻한 고객, 뜨거운 고객을 세 단계로 나눠 영업과 후기 요청 방식을 보여주는 이미지',
    content: [
      {
        type: 'lead',
        text: '장사를 하다 보면 모든 고객에게 비슷한 안내와 설명을 하고 같은 방식으로 문의를 권하게 되는데, 결과는 매번 다릅니다. 어떤 분과는 대화가 술술 풀리는 반면, 어떤 분과는 첫마디부터 단단한 벽이 느껴져요.',
      },
      {
        type: 'temperatureSummary',
        title: '고객 온도는 크게 세 단계로 나뉩니다',
        intro:
          '그럴 때 저는 고객의 온도를 떠올립니다. 원래는 “내 서비스를 얼마나 알고 있나”를 보는 개념인데, 여기에 “나를 얼마나 좋게 보나”까지 함께 생각하면 현장에서 훨씬 쓸모 있어요.',
        items: [
          {
            tone: 'cold',
            label: '차가운 고객',
            status: '우리를 잘 모르고 관심도 아직 적은 상태',
            message: '왜 필요한지부터 알려주기',
            action: '쉬운 정보 글, 체크리스트, 실제 사례',
            avoid: '첫 대화부터 견적·예약 밀어붙이기',
          },
          {
            tone: 'warm',
            label: '따뜻한 고객',
            status: '필요성은 알고 관심도 조금 생긴 상태',
            message: '왜 맡겨도 괜찮은지 보여주기',
            action: '작업 범위, 후기, 전후 사례, 무료 점검',
            avoid: '두루뭉술한 홍보 문구만 반복하기',
          },
          {
            tone: 'hot',
            label: '뜨거운 고객',
            status: '이미 호감과 신뢰가 쌓인 상태',
            message: '바로 움직일 수 있게 안내하기',
            action: '문의 링크, 예약 버튼, 후기 링크, 소개 요청',
            avoid: '이미 아는 기초 설명을 길게 반복하기',
          },
        ],
      },
      {
        type: 'image',
        src: '/blog/customer-temperature-action-map.webp',
        alt: '차가운 고객이 문제를 인식하고 비교 과정을 거쳐 문의하는 흐름을 보여주는 이미지',
        caption:
          '차가운 고객은 문제를 알아가는 중이고, 따뜻한 고객은 여러 선택지를 비교하는 중입니다. 뜨거운 고객은 이미 마음이 어느 정도 정해져 있어 바로 움직이기 쉬워요.',
      },
      {
        type: 'heading',
        title: '1. 차가운 고객에게 바로 팔려고 하면 벽이 생깁니다',
        body: [
          '차가운 고객은 아직 우리를 모릅니다. 가게나 서비스를 처음 들었을 수도 있고, 본인에게 문제가 있다는 것조차 느끼지 못할 수 있어 이해도와 호감도가 거의 없는 상태입니다.',
          '이런 분에게 처음부터 가격표나 예약을 들이밀면 거절이 먼저 나와요. 저도 예전에 영업을 하다가 이런 분을 만났는데, 한참 설명하고 있는 저를 빤히 보더니 “내가 그걸 왜 해야 되는데요?”라고 말했습니다. 그때 그 눈빛은 아직도 기억나요.',
          '돌이켜보면 그분이 까다로웠던 게 아니라 제가 너무 이르게 팔려고 했던 겁니다. 고객의 온도를 먼저 봤다면 그렇게까지 밀어붙이지 않았을 텐데, 차가운 고객을 억지로 끌고 가려 하면 상대도 불편하고 파는 사람도 금방 지치는 것 같아요.',
          '그래서 이런 분에게는 판매보다 “이게 왜 필요한지”를 먼저 보여주는 편이 낫습니다. “구글 지도 정보가 비어 있으면 문의 전에 망설일 수 있습니다” 또는 “인스타만으로는 검색해서 오는 손님을 놓칠 수 있어요”처럼 문제를 쉽게 보여주는 글이 훨씬 잘 맞습니다.',
        ],
      },
      {
        type: 'heading',
        title: '2. 따뜻한 고객은 결정할 근거를 찾고 있습니다',
        body: [
          '따뜻한 고객은 이미 자기 문제를 알고 해결책을 찾고 있으며, 홈페이지가 필요하다는 것과 구글 비즈니스 프로필이 중요하다는 점도 어느 정도 압니다. 우리에게 관심과 호감이 조금 생긴 상태지만, 그렇다고 바로 맡길 준비가 끝난 건 아니에요.',
          '누구에게 맡길지, 가격은 적절한지, 정말 믿을 만한지를 조금 더 확인하고 싶어 하기 때문에 이 단계에서는 “저희가 잘합니다”라는 말보다 직접 보고 판단할 수 있는 자료가 힘을 씁니다.',
          '전후 사례와 실제 점검 항목, 서비스에 포함되는 범위, 고객 후기, 무료 점검 같은 자료가 있으면 대화가 훨씬 수월해져요. 고객이 스스로 비교해 보고 “여기면 괜찮겠다”고 판단할 수 있게 만드는 것이 핵심입니다.',
        ],
      },
      {
        type: 'heading',
        title: '3. 뜨거운 고객에게는 긴 설득이 필요하지 않습니다',
        body: [
          '뜨거운 고객은 이미 우리를 알고 어느 정도 신뢰가 쌓인 분들로, 예전에 서비스를 이용했거나 글을 꾸준히 봤거나 지인 소개로 찾아온 경우가 많습니다. 가끔은 고객이라기보다 팬에 가까운 분도 있어요.',
          '이런 분들과 이야기하면 분위기부터 다릅니다. 질문이 구체적이고 설명도 빨리 알아듣기 때문에, 괜찮은 제안을 드리면 바로 반응합니다.',
          '이때는 억지로 미는 영업이 아니라 서로 필요한 것을 맞춰 가는 대화가 돼요. 조금 과장하면 알래스카에 있는 뜨거운 고객에게 냉장고를 파는 일도 가능할 만큼, 이미 쌓인 호감과 신뢰의 힘이 큽니다.',
          '그래서 긴 설명을 반복하기보다 문의 버튼과 예약 링크, 후기 링크처럼 “바로 할 수 있는 길”을 정확히 알려주면 충분합니다.',
        ],
      },
      {
        type: 'actionRows',
        title: '온도에 따라 첫마디를 바꿉니다',
        intro: '같은 서비스를 소개하더라도 고객의 온도에 따라 첫마디는 달라져야 해요.',
        rows: [
          {
            label: '차가운 고객에게',
            action: '문제를 먼저 보여주세요.',
            example: '“검색했을 때 정보가 비어 있으면, 문의 전에 그냥 나가시게 돼요.”',
          },
          {
            label: '따뜻한 고객에게',
            action: '비교할 근거를 보여주세요.',
            example: '“무료 점검에서는 홈페이지, 구글 프로필, SNS 연결 상태를 함께 확인해 드립니다.”',
          },
          {
            label: '뜨거운 고객에게',
            action: '바로 할 수 있는 행동을 알려주세요.',
            example: '“진행해볼까요? 이 링크로 문의 남겨주시면 현재 상태부터 확인해드릴게요.”',
          },
        ],
      },
      {
        type: 'image',
        src: '/blog/customer-review-request-timing.webp',
        alt: '고객 만족도에 따라 후기를 요청하기 좋은 시점을 보여주는 이미지',
        caption:
          '후기는 모두에게 같은 타이밍에 요청하기보다, 만족과 신뢰가 확인된 분에게 짧고 편하게 부탁하는 편이 좋아요.',
      },
      {
        type: 'heading',
        title: '후기 요청도 타이밍이 전부입니다',
        body: [
          '고객 온도는 영업에만 쓰는 기준이 아니라 작은 비즈니스에서 후기를 부탁할 때도 꽤 쓸 만합니다.',
          '아직 우리를 잘 모르거나 만족도가 애매한 분에게 후기를 부탁하면 서로 부담스럽고, 괜히 관계만 어색해질 수 있어요.',
          '반대로 먼저 “고맙다”고 말해 주는 분이라면 이야기가 다릅니다. 짧게 감사 인사를 전하고 후기 링크를 보내면 생각보다 후기를 잘 남겨주시기 때문에 길게 설명할 필요는 없어요. “만족하셨다니 다행입니다. 괜찮으시면 짧게 후기 하나 부탁드려도 될까요?” 정도면 충분합니다.',
        ],
      },
      {
        type: 'callout',
        title: '오늘부터 이것만 해보세요',
        body: '고객을 만날 때 “이분은 지금 어느 온도일까”만 먼저 떠올려 보세요. 그것만으로도 꺼내는 말이 달라집니다.',
        items: [
          '처음 보는 분에게는 판매보다 문제를 알아볼 수 있는 글을 먼저 보여주세요.',
          '비교 중인 분에게는 후기, 작업 범위, 사례, 무료 점검처럼 판단할 자료를 건네세요.',
          '이미 신뢰가 쌓인 분에게는 문의·예약·후기·소개 요청 링크를 짧고 분명하게 보내세요.',
        ],
      },
      {
        type: 'heading',
        title: '홈페이지와 SNS도 같은 기준으로 봅니다',
        body: [
          '홈페이지, 구글 비즈니스 프로필, 인스타그램도 같은 기준으로 보면 정리가 쉽습니다. 처음 보는 분에게는 우리가 무슨 일을 하는지 바로 알려주고, 비교 중인 분에게는 후기와 사례를 보여주며, 이미 마음이 있는 분에게는 문의 버튼과 예약 방법을 가장 찾기 쉬운 자리에 두면 돼요.',
          '작은 비즈니스일수록 모든 사람을 한 문장으로 설득하려다 금방 지칩니다. 고객을 차갑고, 따뜻하고, 뜨거운 단계로 나눠 그 온도에 맞춰 말을 걸어 보면 영업도 덜 부담스럽고, 온라인에서 무엇을 보여줘야 할지도 훨씬 선명해져요.',
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    relatedPostIds: ['before-starting-seo', 'why-website-does-not-convert', 'what-is-included-in-free-audit'],
    date: '2026.04.10',
    author: 'Goodman SEO',
  ...
  },
  {
    ...
    relatedPostIds: ['before-starting-seo', 'five-online-basics-before-website', 'what-is-included-in-free-audit'],
    date: '2026.04.08',
    author: 'Goodman SEO',
  ...
  },
  {
    ...
    relatedPostIds: ['before-starting-seo', 'why-website-does-not-convert', 'before-building-new-website'],
    date: '2026.04.05',
    author: 'Goodman SEO',
  ...
  },
  {
    ...
    excerpt: '홈페이지가 검색에 안 보이거나 방문해도 문의가 없다면, 구글 등록 상태부터 서비스 설명과 연락 경로까지 차례로 확인하세요. 직접 점검할 항목과 제작자에게 물어볼 내용을 정리했습니다.',
    category: 'SEO',
    image: '/blog/before-starting-seo.webp',
    imageAlt: 'SEO 시작 전 웹사이트 구조와 검색 기본 세팅을 점검하는 이미지',
    relatedPostIds: ['five-online-basics-before-website', 'why-website-does-not-convert', 'what-is-included-in-free-audit'],
    content: [
      { type: 'lead', text: '홈페이지를 만들었는데 구글에서 찾기 어렵다면, 글을 더 쓰기 전에 어디서 막혔는지부터 확인해보세요. 구글이 아직 페이지를 등록하지 않은 경우와 검색에 보이지만 클릭이나 문의가 없는 경우는 손볼 곳이 다릅니다.' },
      { type: 'heading', title: '1. 어떤 검색에서 안 보이는지 적어봅니다', body: [
        '상호명을 검색했는지, 서비스와 지역을 함께 검색했는지부터 구분합니다. 예를 들어 내 업체 이름으로 찾는 것과 “시드니 청소 업체”로 찾는 것은 서로 다른 상황이에요. 실제 검색한 단어와 고객에게 안내하는 홈페이지 주소를 하나씩 적어두세요.',
        '구글 지도에 표시되는 업체 정보와 일반 검색 결과의 웹페이지도 따로 확인해야 합니다. Google Business Profile이 보인다고 홈페이지까지 검색에 등록된 것은 아닙니다.',
      ] },
      { type: 'heading', title: '2. Search Console에서 페이지 등록 상태를 확인합니다', body: [
        'Search Console에서 해당 주소가 포함된 속성을 선택하고, 상단 URL 검사에 전체 주소를 붙여넣습니다. 여기서 색인은 구글이 페이지를 검색에 사용할 수 있도록 저장하는 것을 뜻합니다.',
        '등록되지 않았다면 상세 사유를 확인하세요. “발견됨 — 현재 색인이 생성되지 않음”과 “크롤링됨 — 현재 색인이 생성되지 않음”은 수집 단계가 다릅니다. 이 문구만으로 콘텐츠 품질이나 서버 문제를 단정할 수는 없습니다.',
        '제작자에게는 검사한 주소와 제외 사유를 함께 전달하고, 접근 차단이나 검색 제외 설정이 있는지, 다른 주소가 대표 페이지로 선택됐는지 확인을 요청하면 됩니다. 중복 주소나 리디렉션처럼 검색에서 제외되는 것이 맞는 경우도 있어요.',
        '실시간 테스트 통과는 지금 페이지에 접근할 수 있다는 확인이며, 색인 완료를 뜻하지는 않습니다. 사이트맵 제출 성공도 모든 페이지의 등록을 보장하지 않습니다. 문제를 수정한 뒤 중요한 주소에 색인을 요청할 수 있지만, 같은 주소를 반복해서 요청한다고 더 빨라지지는 않습니다.',
      ] },
      { type: 'heading', title: '3. 고객이 서비스와 제공 지역을 이해할 수 있게 씁니다', body: [
        '홈페이지 첫 화면과 서비스 페이지를 읽고 무엇을 제공하는지, 어느 지역에서 가능한지, 누구에게 맞는지 확인해보세요. “최고의 솔루션” 같은 표현보다 실제 작업과 조건이 보여야 고객이 자기 상황에 맞는지 판단할 수 있습니다.',
        '예를 들어 청소 업체라면 실제 제공하는 청소 종류, 방문 가능한 지역, 견적에 필요한 정보와 별도 작업 범위를 설명할 수 있습니다. 제공하지 않는 지역이나 서비스를 검색어를 넣기 위해 추가하지는 마세요.',
        '페이지 제목과 큰 제목도 본문의 서비스와 맞춥니다. 이미지 설명은 사진이 보여주는 내용을 적고, 자주 묻는 질문에는 고객이 반복해서 물어보는 준비물·진행 절차·포함 범위를 답하면 됩니다.',
      ] },
      { type: 'heading', title: '4. 구글 정보와 문의 경로를 직접 확인합니다', body: [
        '구글 비즈니스 프로필과 홈페이지의 상호, 전화번호, 영업시간, 서비스 안내가 일치하는지 살펴보세요. 예전 연락처나 종료된 서비스가 남아 있다면 고객이 먼저 보는 곳부터 수정합니다.',
        '휴대폰으로 홈페이지에 들어가 전화·이메일·문의 버튼을 눌러보고, 폼은 테스트 문의를 보내 실제 수신까지 확인하세요. 버튼이 보이는 것과 문의가 정상 전달되는 것은 별개의 확인입니다.',
        '글을 다 읽은 사람이 다음에 볼 서비스 설명이나 관련 안내 글도 연결해두세요. 검색 등록을 설명하는 글 뒤에는 관련 없는 최신 소식보다 홈페이지 점검이나 문의 안내가 자연스럽습니다.',
      ] },
      { type: 'heading', title: '5. 노출, 방문, 문의를 나눠서 봅니다', body: [
        'Search Console 실적에서 최근 3개월과 페이지 필터를 선택해 노출·클릭·검색어를 확인합니다. 노출이 적다면 등록 상태와 페이지 주제를 먼저 살펴보고, 노출은 충분한데 클릭이 적다면 검색어의 질문과 제목·본문이 맞는지 비교하세요. 표본이 몇 건뿐이라면 클릭률만으로 제목을 바꾸기에는 근거가 부족합니다.',
        'Analytics에서는 같은 기간의 검색 유입과 도착 페이지를 보고, 문의 폼 제출 성공이 측정되는지도 확인합니다. 전화 버튼 클릭은 실제 통화나 상담 완료와 구분해서 봐야 해요. 핵심 이벤트가 0건이어도 설정이 없거나 수집이 안 됐다면 문의가 없었다고 단정할 수 없습니다.',
        '검색어가 기존 글의 질문과 같다면 부족한 답변을 보완하고, 해결하려는 문제가 다를 때 새 글을 준비합니다. 수정한 날짜와 내용을 기록해두면 이후 변화와 비교하기 쉽습니다.',
      ] },
      { type: 'callout', title: '점검을 요청하기 전에 준비할 내용', items: [
        '고객에게 안내하는 홈페이지 주소와 실제 검색한 단어',
        'URL 검사에 표시된 등록 상태와 상세 사유',
        '주요 서비스, 실제 제공 지역, 현재 사용하는 문의 방법',
        '직접 확인한 문제: 오래된 정보, 작동하지 않는 버튼, 설명이 부족한 페이지',
      ] },
      { type: 'heading', title: '어디까지 직접 하고, 어떤 작업을 맡길지 정합니다', body: [
        '서비스 정보와 연락처는 사업자가 먼저 정리할 수 있습니다. 페이지 접근이나 대표 주소 설정을 확인하기 어렵다면 제작자에게 점검을 요청하고, 홈페이지 설명과 연락 경로에 빠진 부분이 있다면 수정 범위를 나눠보세요.',
        'GoodmanSEO는 홈페이지 제작·정비, Google Business Profile 세팅, 페이지 제목과 설명 등 On-page SEO 기본 세팅을 안내합니다. 무료 점검은 우선 손볼 곳을 확인하는 단계이며, 실제 수정이나 별도 작업 범위는 문의 후 확인합니다.',
      ] },
      { type: 'links', title: '내 상황에 맞는 다음 단계', items: [
        { label: '무료 점검에서 확인하는 내용', to: '/blog/what-is-included-in-free-audit/' },
        { label: '홈페이지 제작 패키지와 포함 범위', to: '/starter-package/' },
        { label: 'SEO 등 서비스별 범위와 가격', to: '/pricing/' },
        { label: '홈페이지 주소와 함께 무료 점검 신청', to: '/contact?type=free-check' },
      ] },
      { type: 'heading', title: '자주 묻는 질문', body: [
        '구글에 등록되면 상위에 나오나요? 색인 여부와 순위는 다릅니다. 등록됐어도 원하는 검색어에서 상위 노출이 보장되지는 않습니다.',
        '글을 매일 쓰면 해결되나요? 접근이나 검색 제외 설정에 문제가 있다면 먼저 해결해야 합니다. 이미 답한 내용을 반복하기보다 고객의 질문에 빠진 답변을 보완하세요.',
        '수정 후 언제 확인하나요? 재수집에는 수일에서 수주가 걸릴 수 있습니다. URL 검사로 상태를 확인하고, 노출·클릭과 문의는 몇 주에 걸쳐 비교하세요. 일정 기간이 지났다는 이유만으로 색인이나 순위 상승을 보장할 수는 없습니다.',
      ] },
      { type: 'links', title: '구글 공식 도움말', items: [
        { label: 'URL 검사 결과와 실시간 테스트의 차이', to: 'https://support.google.com/webmasters/answer/9012289?hl=ko' },
        { label: '수정한 페이지의 재크롤링 요청 안내', to: 'https://developers.google.com/search/docs/crawling-indexing/ask-google-to-recrawl?hl=ko' },
      ] },
    ],
  },
  {
