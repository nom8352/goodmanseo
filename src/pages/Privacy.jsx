  ...
  return (
    <div className="pt-32 pb-24 bg-gradient-to-tr from-[#f7f2ec] via-white to-[#eee7df] text-[#102133] min-h-screen">
      ...
      <div className="container max-w-4xl px-6 text-left">
        <h1 className="text-3xl font-black tracking-[-0.04em] text-[#102133] mb-2">개인정보처리방침</h1>
        ...
        <div className="bg-white border border-[#ded8cf] rounded-[0.7rem] p-8 shadow-[0_24px_60px_rgba(16,33,51,0.04)] space-y-8 leading-relaxed text-[#44515d]">
          ...
          <section>
            <h2 className="text-lg font-bold text-[#102133] mb-3">1. 개인정보의 수집 및 이용 목적</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#102133] mb-3">2. 수집하는 개인정보의 항목</h2>
            <p className="text-[0.92rem]">
          ...
          <section>
            <h2 className="text-lg font-bold text-[#102133] mb-3">3. 개인정보의 보유 및 이용 기간</h2>
            <p className="text-[0.92rem]">
          ...
          <section>
            <h2 className="text-lg font-bold text-[#102133] mb-3">4. 개인정보의 파기절차 및 방법</h2>
            <p className="text-[0.92rem]">
          ...
          <section>
            <h2 className="text-lg font-bold text-[#102133] mb-3">5. 이용자의 권리와 그 행사방법</h2>
            <p className="text-[0.92rem]">
          ...
          <section>
            <h2 className="text-lg font-bold text-[#102133] mb-3">6. 개인정보의 안전성 확보 조치</h2>
            <p className="text-[0.92rem]">
          ...
          <section>
            <h2 className="text-lg font-bold text-[#102133] mb-3">7. 개인정보 보호책임자 및 연락처</h2>
            <p className="text-[0.92rem]">
              개인정보 보호 관련 문의 및 불만 처리는 아래 책임 부서로 연락해 주시기 바랍니다.
            </p>
            <div className="bg-[#f7f2ec] border border-[#ded8cf] rounded-[0.7rem] p-4 mt-3 text-sm">
              <p><strong>책임자:</strong> GoodmanSEO 개인정보 보호 담당자</p>
              <p className="mt-1"><strong>이메일:</strong> <a href="mailto:goodmanseo.sydney@gmail.com" className="text-[#102133] font-bold">goodmanseo.sydney@gmail.com</a></p>
            </div>
          </section>
