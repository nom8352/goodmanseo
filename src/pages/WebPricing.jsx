...
const websitePackages = [
  {
    ...
    points: ['최대 3페이지 제작', '소개/서비스/문의 구성', '모바일 화면 기본 세팅', '기본 SEO 세팅'],
    cta: '스타터 패키지 문의하기',
  ...
  },
  {
    ...
    points: ['최대 7페이지 제작', '상세 서비스 페이지 구성', '전화/이메일/문의폼 연결', '주요 페이지 SEO 정리', '기본 소셜 링크 연결 지원'],
    cta: '비즈니스 패키지 문의하기',
  ...
  },
  {
    ...
    points: ['10페이지 이상 제작', '비즈니스 홈페이지 항목 포함', 'SEO All-in-One 패키지 포함', 'Google Business Profile 정리', '3개월 AI 고객 안내 지원'],
    cta: '성장형 패키지 문의하기',
