  ...
  return (
    <div className="pt-32 pb-24 bg-gradient-to-tr from-[#f2fafb] via-white to-[#ecf6f8] text-[#0f2230] min-h-screen">
      ...
      <div className="container max-w-4xl px-6 text-left">
        <h1 className="text-3xl font-black tracking-[-0.04em] text-[#0f2230] mb-2">이용약관</h1>
        ...
        <div className="bg-white border border-[#e2e8f0] rounded-3xl p-8 shadow-[0_24px_60px_rgba(0,122,140,0.04)] space-y-8 leading-relaxed text-[#4e6170]">
          ...
          <section>
            <h2 className="text-lg font-bold text-[#0f2230] mb-3">제 1 조 (목적)</h2>
            <p className="text-[0.92rem]">
              본 약관은 GoodmanSEO(이하 "회사"라 함)가 제공하는 온라인 채널 점검, 컨설팅 및 관련 마케팅 지원 서비스(이하 "서비스"라 함)의 이용 조건 및 절차, 이용자와 회사 간의 권리, 의무 및 책임 사항을 규정함을 목적으로 합니다.
            </p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-[#0f2230] mb-3">제 2 조 (용어의 정의)</h2>
            <p className="text-[0.92rem]">
              본 약관에서 사용하는 용어의 정의는 다음과 같습니다.
            </p>
            <ul className="list-disc pl-5 mt-2 space-y-1 text-[0.92rem]">
              <li><strong>이용자:</strong> 본 약관에 따라 회사가 제공하는 무료 채널 점검 또는 paid 진단 서비스를 신청하고 이용하는 자를 말합니다.</li>
              <li><strong>무료 채널 점검:</strong> 이용자가 제공한 구글 비즈니스 프로필, 홈페이지, SNS 채널 등을 기반으로 기본적인 보완점을 진단하는 무상 서비스를 의미합니다.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-lg font-bold text-[#0f2230] mb-3">제 3 조 (약관의 효력 및 변경)</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#0f2230] mb-3">제 4 조 (서비스 신청 및 제공)</h2>
            <ul className="list-decimal pl-5 space-y-1 text-[0.92rem]">
          ...
          <section>
            <h2 className="text-lg font-bold text-[#0f2230] mb-3">제 5 조 (회사의 의무와 책임 한계)</h2>
            <ul className="list-decimal pl-5 space-y-1 text-[0.92rem]">
          ...
          <section>
            <h2 className="text-lg font-bold text-[#0f2230] mb-3">제 6 조 (이용자의 의무)</h2>
            <p className="text-[0.92rem]">
          ...
          <section>
            <h2 className="text-lg font-bold text-[#0f2230] mb-3">제 7 조 (관할법원)</h2>
            <p className="text-[0.92rem]">
